              ...
              <div className="product d-flex">
                <div className="item">
                  <div className="product">
                    <a href="#" className="img-prod"><img className="img-fluid" src="images/images-product-1.jpg"
                ...
                <div className="item">
                  <div className="product">
                    <a href="#" className="img-prod"><img className="img-fluid" src="images/images-product-2.jpg"
                ...
                <div className="item">
                  <div className="product">
                    <a href="#" className="img-prod"><img className="img-fluid" src="images/images-product-3.jpg"
                      alt="Colorlib Template" /></a>
                    <div className="text pt-3 px-3">
                      <h3><a href="#">Young Woman Wearing Dress</a></h3>
                      <div className="d-flex">
                ...
                <div className="item">
                  <div className="product">
                    <a href="#" className="img-prod"><img src="images/images-product-5.jpg" alt="Colorlib Template" />
                      <span className="status">30%</span>
                    </a>
                    <div className="text pt-3 px-3">
                      <h3><a href="#">Young Woman Wearing Dress</a></h3>
                ...
                <div className="item">
                  <div className="product">
                    <a href="#" className="img-prod"><img src="images/images-product-6.jpg" alt="Colorlib Template" /></a>
                    <div className="text pt-3 px-3">
                      <h3><a href="#">Young Woman Wearing Dress</a></h3>
                      <div className="d-flex">
                        <div className="pricing">
