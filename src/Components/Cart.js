...
const Cart = (props) => {
	...
	return (
		<div>
				...
				<div class="container p-4">
					<div class="row no-gutters slider-text align-items-center justify-content-center">
						<div class="col-md-9 ftco-animate text-center fadeInUp ftco-animated">
							<h1 class="mb-0 bread">Shopping Bag</h1>
						</div>
					</div>
				</div>
			</div>
			<div class="container">
				<div class="row">
					<div class="col-md-9 pt-4 mt-5 ftco-animate fadeInUp ftco-animated">
						<div class="cart-list">
							<table class="table">
												...
												<td className="w-75">
													<div className=' m-0 p-0'>
														...
														<div className='d-flex m-0 p-0'>
															<div class="select-wrap w-25">
																<div class="form-group d-flex">
																	<div class="select-wrap">
																		<div class="icon">
																			{/* <span class="ion-ios-arrow-down"></span> */}
																		</div>
																		<select name="" id="" class="p1" value={item.selectedSize} onChange={e => console.log(e.target.value)}>
															...
															<div class="select-wrap w-25 ml-5">
																<div class="form-group d-flex">
																	<div class="select-wrap">
																		<div class="icon">
																			{/* <span class="ion-ios-arrow-down"></span> */}
					...
					<div class="col col-lg-3 w-100 pt-4 mt-5 ct-5 cart-wrap ftco-animate fadeInUp ftco-animated">
						...
						<p class="text-center">
							<Link to="/verifyPhoneNumber" class="btn btn-primary py-3 px-4">Proceed to Checkout</Link></p>
					</div>
				</div>
				<p>	<div onClick={() => dispatch({ type: 'CART_EMPTY_PRODUCT' })} to="/verifyPhoneNumber" class="btn btn-primary py-3 px-4">Empty Cart</div></p>
